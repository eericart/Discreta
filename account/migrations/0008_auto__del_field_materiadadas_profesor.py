...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MateriaDadas.profesor'
        db.delete_column(u'account_materiadadas', 'profesor_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MateriaDadas.profesor'
        raise RuntimeError("Cannot reverse this migration. 'MateriaDadas.profesor' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'MateriaDadas.profesor'
        db.add_column(u'account_materiadadas', 'profesor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Profesor']),
                      keep_default=False)
