...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'UserProfile.carrera'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.carrera' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserProfile.carrera'
        db.alter_column(u'account_userprofile', 'carrera_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.Carrera'], unique=True))
