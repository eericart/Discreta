...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.total_credito_aprobado'
        db.delete_column(u'account_userprofile', 'total_credito_aprobado')
        ...
        # Adding field 'MateriaAprobada.user'
        db.add_column(u'account_materiaaprobada', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['account.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.total_credito_aprobado'
        db.add_column(u'account_userprofile', 'total_credito_aprobado',
        ...
        # Deleting field 'MateriaAprobada.user'
        db.delete_column(u'account_materiaaprobada', 'user_id')
