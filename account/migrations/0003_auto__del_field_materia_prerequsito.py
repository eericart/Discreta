...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Materia.prerequsito'
        db.delete_column(u'account_materia', 'prerequsito_id')

        # Adding M2M table for field prerequsito on 'Materia'
        m2m_table_name = db.shorten_name(u'account_materia_prerequsito')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_materia', models.ForeignKey(orm[u'account.materia'], null=False)),
            ('to_materia', models.ForeignKey(orm[u'account.materia'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_materia_id', 'to_materia_id'])


    def backwards(self, orm):
        # Adding field 'Materia.prerequsito'
        db.add_column(u'account_materia', 'prerequsito',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Materia'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field prerequsito on 'Materia'
        db.delete_table(db.shorten_name(u'account_materia_prerequsito'))
