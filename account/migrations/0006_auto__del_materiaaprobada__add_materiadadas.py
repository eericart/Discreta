...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MateriaDadas'
        db.create_table(u'account_materiadadas', (
        ...
        db.send_create_signal(u'account', ['MateriaDadas'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'MateriaDadas'
        db.delete_table(u'account_materiadadas')
