...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProfesorRate.rate'
        db.delete_column(u'account_profesorrate', 'rate')

        # Adding field 'ProfesorRate.rate_votes'
        db.add_column(u'account_profesorrate', 'rate_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'ProfesorRate.rate_score'
        db.add_column(u'account_profesorrate', 'rate_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProfesorRate.rate'
        db.add_column(u'account_profesorrate', 'rate',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ProfesorRate.rate_votes'
        db.delete_column(u'account_profesorrate', 'rate_votes')

        # Deleting field 'ProfesorRate.rate_score'
        db.delete_column(u'account_profesorrate', 'rate_score')
    ...
    models = {
        ...
        u'account.materiadadas': {
            'Meta': {'object_name': 'MateriaDadas'},
        ...
        u'account.profesorrate': {
            ...
            'rate_score': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'rate_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.UserProfile']"})
        },
        u'account.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            'carrera': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.Carrera']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
