...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['carrera']
        db.delete_unique(u'account_userprofile', ['carrera_id'])


        # Changing field 'UserProfile.carrera'
        db.alter_column(u'account_userprofile', 'carrera_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 1, 15, 0, 0), to=orm['account.Carrera']))

    def backwards(self, orm):

        # Changing field 'UserProfile.carrera'
        db.alter_column(u'account_userprofile', 'carrera_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.Carrera'], unique=True, null=True))
        # Adding unique constraint on 'UserProfile', fields ['carrera']
        db.create_unique(u'account_userprofile', ['carrera_id'])
